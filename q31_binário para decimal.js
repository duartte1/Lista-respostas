...
// Entrada
const numero_binário_nibble = Number(input('Valor do numero binário nibble: '))

// Processamento
const milhar = Number(input(numero_binário_nibble / 1000))
const resto_1 = Number(input(numero_binário_nibble % 1000))
...
// Saída
console.log('O valor do numero binário nibble em decimal é', numero_decimal)